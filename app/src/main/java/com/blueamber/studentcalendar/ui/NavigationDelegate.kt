...
class NavigationDelegate(
    ...
    init {
        fragmentManager.addOnBackStackChangedListener{ currentFragment()?.userVisibleHint = true }
    }

    private fun currentFragment(): Fragment? =
        fragmentManager.findFragmentByTag((fragmentManager.backStackEntryCount - 1).toString())
